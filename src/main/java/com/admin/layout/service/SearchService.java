...
public class SearchService {
    ...
    public static ArrayList<Pill2> getPillList(String title) {
        ...
        try {
            ...
            for (int i = 0; i < array.size(); i++) {
                ...
                String useMethodQesitm1 = (String) temp.get("useMethodQesitm"); // 효과
                String efcyQesitm = (String) temp.get("efcyQesitm"); // 사용방법
